...
const colList = [
  { id: "id_sales",  label: "ID",  number: false,  align: "center",  pk_visible: true, array: "Sales"},
  { id: "no_client",  label: "Cliente",  number: false,  align: "center", array: "Client"},
  { id: "nu_value",  label: "Valor",  number: true,  align: "center", array: "Sales"},
  { id: "dt_sale",  label: "Data",  number: false,  align: "center", array: "Sales", format: formatDate},
];
